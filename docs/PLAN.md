...
| สุ่ม | กดครั้งเดียวได้ครบ 8 สูตร · admin เลือกโหมด **วันละ 1 / วันละ 3 / ไม่จำกัด** + ปุ่มรีเซ็ตสิทธิ์ทุกคน · นับใหม่ทุก 00:00 เวลาไทย · บังคับที่ DB (`settings`, `create_roll_batch`) |
